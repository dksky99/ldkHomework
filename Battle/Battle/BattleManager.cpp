...
int BattleManager::TeamAllDead(vector<shared_ptr<class Creature>>& team)
{
    int n = 0;
...
void BattleManager::Update(vector<shared_ptr<class Creature>>& team1, vector<shared_ptr<class Creature>>& team2)
{
...
void BattleManager::CreateTeam()
{
    ...
    players.push_back(make_shared<Archer>("A1", 120, 25, 12, 10));
    players.push_back(make_shared<Archer>("A2", 160, 20, 12, 10));
    players.push_back(make_shared<Archer>("A3", 140, 23, 12, 10));
    players.push_back(make_shared<Archer>("A4", 130, 22, 12, 10));
    players.push_back(make_shared<Knight>("K1", 300, 10, 20, 10));
    players.push_back(make_shared<Knight>("K2", 200, 20, 15, 10));
    players.push_back(make_shared<Knight>("K3", 250, 15, 16, 10));
    players.push_back(make_shared<Mage>("M1", 100, 15, 8, 10));
    players.push_back(make_shared<Mage>("M2", 120, 20, 8, 10));
    players.push_back(make_shared<Mage>("M3", 140, 25, 8, 10));
    ...
    monsters.push_back(make_shared<KingGoblin>("KG4", 2000, 30, 25, 10));
