...
#include "LDK_Prototype/MyHpBar.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMyHpBar() {}

// Begin Cross Module References
LDK_PROTOTYPE_API UClass* Z_Construct_UClass_UMyHpBar();
LDK_PROTOTYPE_API UClass* Z_Construct_UClass_UMyHpBar_NoRegister();
...
template<> LDK_PROTOTYPE_API UClass* StaticClass<UMyHpBar>()
{
	return UMyHpBar::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Git_ldkHomework_ldkHomework_LDK_Prototype_Source_LDK_Prototype_MyHpBar_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMyHpBar, UMyHpBar::StaticClass, TEXT("UMyHpBar"), &Z_Registration_Info_UClass_UMyHpBar, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMyHpBar), 1557508991U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Git_ldkHomework_ldkHomework_LDK_Prototype_Source_LDK_Prototype_MyHpBar_h_3990824547(TEXT("/Script/LDK_Prototype"),
	Z_CompiledInDeferFile_FID_Git_ldkHomework_ldkHomework_LDK_Prototype_Source_LDK_Prototype_MyHpBar_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Git_ldkHomework_ldkHomework_LDK_Prototype_Source_LDK_Prototype_MyHpBar_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
